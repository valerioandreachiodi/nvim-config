...
local cheatsheet_lines = {
  ...
  "  <leader>xc       → Apri/Chiudi il Cheatsheet",  
  "",
  "  Modalità",
  "  i        → Inserisci",
  "  v        → Visuale",
  ...
  "",
  " Toggle Paste mode",
  "  <leader>q       → Toggle paste mode (incolla lungo senza rompere l'indentazione)",
  "                  → ON prima di incollare, OFF dopo",
  "",
  ...
  "",
  "󰘳   Render-markdown.nvim ",
  "  <leader>a      → Anteprima Markdown",
  " Scorciatoia personalizzata che uso per aprire le azioni principali",
  "",
  "  Macro",
